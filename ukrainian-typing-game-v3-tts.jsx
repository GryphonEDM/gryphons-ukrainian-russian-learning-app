...
const UKRAINIAN_KEYBOARD = [
  [
    { uk: 'й', qwerty: 'q', sound: 'y (short)', finger: 'pinky-l' },
    { uk: 'ц', qwerty: 'w', sound: 'ts', finger: 'ring-l' },
    { uk: 'у', qwerty: 'e', sound: 'oo', finger: 'middle-l' },
    { uk: 'к', qwerty: 'r', sound: 'k', finger: 'index-l' },
    { uk: 'е', qwerty: 't', sound: 'eh', finger: 'index-l' },
    { uk: 'н', qwerty: 'y', sound: 'n', finger: 'index-r' },
    { uk: 'г', qwerty: 'u', sound: 'h (voiced)', finger: 'index-r' },
    { uk: 'ш', qwerty: 'i', sound: 'sh', finger: 'middle-r' },
    { uk: 'щ', qwerty: 'o', sound: 'shch', finger: 'ring-r' },
    { uk: 'з', qwerty: 'p', sound: 'z', finger: 'pinky-r' },
    { uk: 'х', qwerty: '[', sound: 'kh', finger: 'pinky-r' },
    { uk: 'ї', qwerty: ']', sound: 'yee', finger: 'pinky-r' },
  ],
  [
    { uk: 'ф', qwerty: 'a', sound: 'f', finger: 'pinky-l' },
    { uk: 'і', qwerty: 's', sound: 'ee', finger: 'ring-l' },
    { uk: 'в', qwerty: 'd', sound: 'v', finger: 'middle-l' },
    { uk: 'а', qwerty: 'f', sound: 'ah', finger: 'index-l' },
    { uk: 'п', qwerty: 'g', sound: 'p', finger: 'index-l' },
    { uk: 'р', qwerty: 'h', sound: 'r (rolled)', finger: 'index-r' },
    { uk: 'о', qwerty: 'j', sound: 'oh', finger: 'index-r' },
    { uk: 'л', qwerty: 'k', sound: 'l', finger: 'middle-r' },
    { uk: 'д', qwerty: 'l', sound: 'd', finger: 'ring-r' },
    { uk: 'ж', qwerty: ';', sound: 'zh (pleasure)', finger: 'pinky-r' },
    { uk: 'є', qwerty: "'", sound: 'yeh', finger: 'pinky-r' },
  ],
  [
    { uk: 'я', qwerty: 'z', sound: 'ya', finger: 'pinky-l' },
    { uk: 'ч', qwerty: 'x', sound: 'ch', finger: 'ring-l' },
    { uk: 'с', qwerty: 'c', sound: 's', finger: 'middle-l' },
    { uk: 'м', qwerty: 'v', sound: 'm', finger: 'index-l' },
    { uk: 'и', qwerty: 'b', sound: 'ɪ (short i)', finger: 'index-l' },
    { uk: 'т', qwerty: 'n', sound: 't', finger: 'index-r' },
    { uk: 'ь', qwerty: 'm', sound: '(soft sign)', finger: 'index-r' },
    { uk: 'б', qwerty: ',', sound: 'b', finger: 'middle-r' },
    { uk: 'ю', qwerty: '.', sound: 'yu', finger: 'ring-r' },
    { uk: '.', qwerty: '/', sound: '(period)', finger: 'pinky-r' },
  ]
];
...
// Lesson content organized by difficulty
const LESSONS = {
  1: {
    name: "Home Row Heroes",
    nameUk: "Герої домашнього ряду",
    icon: "🏠",
    description: "Master the middle row - where your fingers rest!",
    hint: "These keys are right under your fingers on the home row",
    letters: ['ф', 'і', 'в', 'а', 'п', 'р', 'о', 'л', 'д'],
    words: ['від', 'рід', 'вода', 'пора', 'лапа', 'діло', 'воля', 'доля', 'пара', 'рада'],
    xpPerLetter: 10,
    xpPerWord: 25,
    requiredXp: 0
  },
  2: {
    name: "Vowel Valley",
    nameUk: "Долина голосних",
    icon: "🅰️",
    description: "Add the top row - focus on vowels!",
    hint: "Ukrainian has 10 vowels: а, е, и, і, о, у, є, ї, ю, я",
    letters: ['у', 'е', 'і', 'а', 'о', 'и'],
    words: ['око', 'вухо', 'море', 'поле', 'село', 'небо', 'дерево', 'озеро'],
    xpPerLetter: 12,
    xpPerWord: 30,
    requiredXp: 150
  },
  3: {
    name: "Consonant Castle",
    nameUk: "Замок приголосних",
    icon: "🏰",
    description: "Time for the common consonants!",
    hint: "н, т, с, к are very common in Ukrainian",
    letters: ['н', 'т', 'с', 'к', 'м', 'р', 'в'],
    words: ['кіт', 'сон', 'там', 'тут', 'так', 'ні', 'він', 'вона', 'вони', 'мати', 'тато'],
    xpPerLetter: 12,
    xpPerWord: 35,
    requiredXp: 350
  },
  4: {
    ...
    nameUk: "Пригоди алфавіту",
    icon: "🎯",
    description: "Explore more of the Ukrainian alphabet!",
    hint: "й, ц, г, ш, щ, з, х - the top row awaits!",
    letters: ['й', 'ц', 'г', 'ш', 'щ', 'з', 'х', 'ї'],
    words: ['хліб', 'цей', 'цукор', 'школа', 'щастя', 'зима', 'їжа', 'їхати'],
    xpPerLetter: 15,
    xpPerWord: 40,
    requiredXp: 600
  },
  5: {
    name: "Bottom Row Bonanza",
    nameUk: "Бонанза нижнього ряду",
    icon: "⬇️",
    description: "Complete the keyboard with the bottom row!",
    hint: "я, ч, ь, б, ю - the final frontier!",
    letters: ['я', 'ч', 'ь', 'б', 'ю'],
    words: ['яблуко', 'чай', 'читати', 'любов', 'людина', 'будинок', 'бути', 'юнак'],
    xpPerLetter: 15,
    xpPerWord: 45,
    requiredXp: 900
  },
  ...
  9: {
    name: "Kitchen Quest",
    nameUk: "Кухонний квест",
    icon: "🍲",
    description: "Delicious Ukrainian vocabulary!",
    hint: "Ukrainian cuisine is amazing - learn the words!",
    letters: [],
...
// Text-to-Speech for Ukrainian pronunciation
const speakUkrainian = (text, rate = 0.8) => {
  ...
  const speak = () => {
    ...
    const ukrainianVoice = voices.find(v => v.lang === 'uk-UA') ||
                           voices.find(v => v.lang.startsWith('uk')) ||
                           voices.find(v => v.lang === 'ru-RU') ||
                           voices.find(v => v.lang.startsWith('ru')) ||
                           voices.find(v => v.lang.includes('Google') && v.lang.startsWith('uk')) ||
                           null;
    ...
    if (ukrainianVoice) {
      ...
      // Force Ukrainian lang even without a specific voice - browser may still handle it
...
export default function UkrainianTypingGame() {
  ...
  useEffect(() => {
    try {
      localStorage.setItem('ukrainianTypingProgress', JSON.stringify({
  ...
  const getNextTarget = useCallback((mode, level) => {
  ...
  const startExercise = useCallback((mode, level) => {
    ...
    setCurrentTarget(getNextTarget(mode, level));
    setCurrentInput('');
    setCurrentIndex(0);
    setMistakes(0);
    setWordMistakes(0);
  ...
  const handleKeyPress = useCallback((e) => {
    ...
    if (key === targetChar || e.key === targetChar) {
      ...
      if (soundEnabled) {
        ...
        playSound('correct', audioContextRef.current);
      }
      
      // Speak the letter using TTS
      if (ttsEnabled) {
        speakUkrainian(targetChar, 0.9);
      }
      ...
      if (newIndex >= currentTarget.length) {
        ...
        if (soundEnabled) {
          ...
          playSound('complete', audioContextRef.current);
        }
        
        // Speak the complete word using TTS (after a brief delay so it doesn't overlap with the last letter)
        if (ttsEnabled) {
          setTimeout(() => {
            speakUkrainian(currentTarget, 0.75); // Slightly slower for the whole word
          }, 300);
        }
      ...
      typedVowels, soundEnabled, checkAchievements, checkSpeedAchievement, getNextTarget]);
        ...
        {gameMode === 'menu' ? (
          ...
          <div className="practice-screen">
            ...
            <div className="lesson-header">
              <span className="lesson-icon">{LESSONS[currentLevel].icon}</span>
